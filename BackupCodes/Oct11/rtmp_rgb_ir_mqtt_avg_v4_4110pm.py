...
def calculatecoords(xPixVal, yPixVal):
    ...
    xPixMax = 720 
    yPixMax = 640
    height = 35 #40 #45 # Put height of the drone during the flight in meters
    pitch = 90 * math.pi / 180 - 0.000001 # INPUT pitch of the camera, facing down: 90, facing 45: 45, facing forward: 0

    # Variable
    heading = (_latest["head"] + 360) % 360 * math.pi / 180 - 0.000001 # north: 0, east: 90, south: 180, west: 270
